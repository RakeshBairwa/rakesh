...
var fs = require('fs');
var options = {
   key  : fs.readFileSync('/etc/nginx/ssl/neurobot.in.key'),
   cert : fs.readFileSync('/etc/nginx/ssl/1neurobot.in.chained.crt'),
   ca   : fs.readFileSync('/etc/nginx/ssl/intermediate.crt')
};
...
var server = https.createServer(options, restService);
